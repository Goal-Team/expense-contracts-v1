                  ...
                  <div class="misgtable topone" style="display:none">
                    ...
                    @foreach ($reqfieldsVal as $key => $vals)
                        ...
                        @if(!$vals)
                            ...
                            @endphp
                        @endif
                          <div id="{{$key.'-section-id'}}" class="approvalInpsSection">
                            ...
                            @if(empty($inpVal))
                                <span class="text-danger mandateFieldReq">Required</span>
                            @endif
                          </div>
                    @endforeach
                 </div>                
        ...
        <div class="card h-100">
            <div>
                <button type= "button" class=" btn btn-outline-primary text-nowrap d-inline-flex position-relative me-4 waves-effect mt-3"
                    ...
                    {{ $contract->contract_status }} - {{ $contract->substatus }} - Sequential Approval Flow
                </button>
                <div class="divider">
                ...
                @if( Helper::accessInfo(json_decode($approvalsData[0]->username)->email) )
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between text-center gap-6">
                        ...
                        <div class="d-flex flex-column align-items-center" style="cursor: pointer;">
                            ...
                            <p style="color: #4CAF50;" class="my-2">Click Icon to Send For {{ decryptString($contract->contract_mode, 'contract_mode')  == 'new' ? 'Review' : 'Approval' }}</p>
                        </div>
                        <div class="d-flex flex-column align-items-center">
                ...
                @else
                  <div class="alert alert-warnig" role="alert">Looks like you don’t have permission to the current stage. Please reach out to your admin for help.</div>
                @endif
        </div>
    </div>
</div>
            ...
            <div class="col py-2">
                <div class="col-xl-12 mb-6 mb-xl-0">
                    <div class="card">
                        ...
                        @endif
                        <div class="card-body {{ $approvalsValues->approval_status }}_timelines {{  ($approvalsValues->approval_status == 'pending') ? '': 'd-none'}}">
                                        ...
                                        <div class="latestReview" id="updatesDiv{{ $loop->index }}" style="display:none;">
                                            ...
                                            @endif
                                                <div style="height: 50px;margin-top: 20px;padding: 15px;margin-bottom: 10px;" id="finalActionDiv">
                                                    <button type="submit" id="btn_save_updates" data-loading-text="Loading..."

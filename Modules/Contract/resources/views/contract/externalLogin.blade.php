...
@section('title', 'Contracts - Virtual Sign Portal')
<!-- Vendor Styles -->
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center mb-6">
                <span><img src="{{url('assets/logo/OnTrackLogo.png')}}" width="180" alt="ONTRACK" /></span>
            </div>
            <!-- /Logo -->
            <h4 class="mb-1">Welcome Virtual Sign Portal! <i class="icon-base ti ti-signature"></i></h4>
            <p class="mb-6">Please sign-in to your account</p>

            <form method="POST" action="{{url('contracts/external/accessCheck')}}" class="mb-4 fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                <input type="hidden" name="contractToken" value="{{$exId}}" />                
              <div class="mb-6 form-control-validation fv-plugins-icon-container">
                <label for="email" class="form-label">Email or Username</label>
                <input type="text" class="form-control" id="email" name="exusername" placeholder="Enter your email or username" autofocus="">
              ...
              <div class="mb-6 form-password-toggle form-control-validation fv-plugins-icon-container">
                ...
                <div class="input-group input-group-merge has-validation">
                  <input type="password" id="password" class="form-control" name="expassword" placeholder="············" aria-describedby="password">
                  <span class="input-group-text cursor-pointer"><i class="icon-base ti tabler-eye-off"></i></span>
                </div><div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>
              <div class="my-4">
                <button type="submit" class="btn btn-primary d-grid w-100 waves-effect waves-light" type="submit">Login</button>
              </div>
            </form>
          </div>
        </div>

...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
   <div class="d-flex flex-column justify-content-center">
      <h4 class="mb-1 mt-3">Termination</h4>
   </div>
...
<div class="row my-4">
   <div class="col">
      <form class="" id="createcontract" action="{{ url('contracts/terminateContract') }}" method="POST" 
                enctype="multipart/form-data">
         @csrf
         <input type="hidden" id="contractId" name="contractId" class="form-control" value="{{$contract_id}}">
                  ...
                  <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                     <div class="accordion-body">
                        <div class="row g-3">
                           <div class="col-md-6">
                              <div class="form-group">
                                    ...
                                    <div class="clearfix row">
                                        <div class="">
                                            <input type="date" id="terminationDate"  name="terminationDate" class="form-control flatpickr" 
                                            />
                                        </div>
                                    </div>
                                </div>
                           ...
                           <!--         <input type="text" class="form-control"  id="terminateObligation" />-->
                           <!--     </div>-->
                           <!--</div>-->
                           <div class="col-md-6">
                                <div class="form-group">
                                    <label >Reason For Termination</label>
                                    <textarea class="form-control" id="terminationReason" 
                                            name="terminationReason" rows="4"></textarea>
                                </div>
                           </div>
                           <div class="col-md-6">
                                <div class="form-group">
                                    <label >Any Other Remarks</label>
                                    <textarea class="form-control" id="terminationRemarks" 
                                            name="terminationReason" rows="4"></textarea>
                                </div>
                           </div>
                        </div>

                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group" style=" margin-top: 20px;">      
                            ...
                            <input type="text" class="form-control" id="name_of_task" name="name_of_task" value="{{old('name_of_task')}}"/>  
                        </div>
                        <div class="form-group" style=" margin-top: 20px;">      
                        ...
                        <div class="form-group" style=" margin-top: 20px;">      
                            ...
                            <textarea type = "text" class="form-control" name="task_desc" id="task_desc" rows ="4">{{old('task_desc')}}</textarea>
                        </div>
                        ...
                        <div class="form-group" style=" margin-top: 20px;">      
                            ...
                            <select class="select2 form-select" id="branch" name = "branch"  aria-label="Default select example">
                                ...
                                @foreach($branch as $br_data)
                                    <option  value="{{$br_data->id}}" {{ (old('branch') == $br_data->id ? 'selected' : '' ) }}>{{$br_data->LegalName}}</option>
                                @endforeach
                            </select>  
                        </div>
                        <div class="form-group" style=" margin-top: 20px;">      
                    ...
                    <div class="col-md-4">
                        <div class="form-group" style=" margin-top: 20px;">      
                            ...
                            <select class="select2 form-select" id="status" name = "status"  aria-label="Default select example">
                                <option selected>Choose Status</option>
                                <option {{ (old('status') == 'pending' ? 'selected' : '' ) }} value="pending">Pending</option>
                                <option {{ (old('status') == 'inprogress' ? 'selected' : '' ) }} value="inprogress">Inprogress</option>
                        ...
                        <div class="form-group" style=" margin-top: 20px;">      
                            ...
                            <select class="select2 form-select" id="task_reviewer" name ="task_reviewer"  aria-label="Default select example">
                                ...
                                @foreach($add_users as $add_users_data)
                                    <option  value="{{$add_users_data->id}}" {{ (old('task_reviewer') == $add_users_data->id ? 'selected' : '' ) }}>{{$add_users_data->FirstName." ".$add_users_data->LastName}}</option>
                                @endforeach
                            </select>  
                        </div>

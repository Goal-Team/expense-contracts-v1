            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
               ...
               <div class="d-flex align-content-center flex-wrap gap-3">
                  <div class="d-flex gap-3">
                      <a href="{{url('/')}}/parties/contract-parties-ind-edit/{{$parties->id}}" style="color: #FFF;text-decoration: none;"><button type="button" class="btn btn-label-warning">Edit</button></a>
...
<div class="col-md-6 mt-2">
                                    ...
                                    <div class="col-md-12 p-2">
                                            @include('contract::contract.viewDetailCustomFieldParty', ['categoryId' => 9])
                                     </div>
                        ...
                        <div class="accordion-item card mt-4">
                          ...
                          <div id="accordionWithIcon-3" class="accordion-collapse collapse">
                                             ...
                                             <div class="col-md-6 mt-2">
                                                <label for="engagement_level" class="form-label required">Engagement Level</label>
                                                  <div class="mt-2">
                                                    ...
                                                    <select class="select2 form-select mt-2" aria-label="select example" id="engagement_access_level" disabled name="engagement_access_level" style="display: none;">
                                                    ...
                                                    <select class="select2 form-select mt-2" aria-label="select example" id="engagement_branch" disabled name="engagement_branch" style="display: none;">
                             ...
                             <div class="col-md-12 p-2">
                                            @include('contract::contract.viewDetailCustomFieldParty', ['categoryId' => 11])
                                     </div>
                          </div>
                       </div>
                           <div class="accordion-item card mt-4">
                              ...
                              <div id="accordionWithIcon-4" class="accordion-collapse collapse">
                                 <div class="accordion-body">
                                    <hr class="mt-1" />
                                    <div class="col-md-12 p-2">
                                            @include('contract::contract.viewDetailCustomFieldParty', ['categoryId' => 12])
                                     </div>
                                    <div class="row g-3">
                                         <div class="row">

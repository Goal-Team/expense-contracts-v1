...
$(document).ready(function() {  
    ...
    //@date:: 21 May 2024,  @author :: Mangaleswari, @desc:: Representative add row funtion
        ...
        $(document).on('click', '#parties_form #representative_add_row', function (event) {

        var position = parseInt($('#parties_form #position').val())+1;
        var count = parseInt($('#parties_form #position').val());
        ...
        $.ajax({
                ...
                success:function(data) {
                    ...
                    if(data)
                    {
                        $('#parties_form #representative_section').append(data);
                        $('#parties_form #position').val(position);
                        return true;
                    }else
                    {
                        return false;
    ...
    $('#parties_form').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: APP_URL + '/parties/contract-parties-org-add?by=ajax',

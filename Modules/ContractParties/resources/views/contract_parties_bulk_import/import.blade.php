    ...
    <div class="container network_wrapper col-sm p-2">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Bulk Upload Contract Parties <span class="badge bg-primary">Organization</span></h5>
                    ...
                    <div class="tab-pane fade {{ (session('data')) ? 'show active' : '' }}" id="verify-info" role="tabpanel" aria-labelledby="verify-info-tab">
                        ...
                        <div class="row my-4">
                            <div class="col">
                                ...
                                <form id="createcontract" action="{{ url('parties/builk-org-import/upload') }}"
                                        ...
                                        foreach (session('data') as $sheetName => $sheetData){
                                            if(strtolower($sheetName) == 'organization'){
                                                ...
                                                foreach (array_slice($sheetData, 1) as $row){
                                                    ...
                                                    if (array_filter($row)){
                                                    $sheetBodyHtml .="<tr>";
                                                        if(isset($dataample[$row['2'].$row['4'].$row['5']])){
                                                        $totalRows++;

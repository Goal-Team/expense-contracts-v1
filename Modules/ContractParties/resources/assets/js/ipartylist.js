...
$(function () {
  ...
  if (dt_filter_table.length) {
    ...
    var dt_filter = dt_filter_table.DataTable({
      ...
      ajax: APP_URL + '/parties/data?partysub=individual&status=' + (_getCookie('pfilterStatus') ?? $('#fstatus').val()),
      columns: [
        { data: 'id',   render : function ( data, type, row, meta ) 
           ...
           {
            var button = '<a href="' + APP_URL + '/parties/contract-parties-ind-view/' + data.id+'" class="btn btn-sm btn-icon dropdown-toggle hide-arrow text-body" data-bs-toggle="tooltip" title="Preview"><i class="ti ti-eye mx-2 ti-sm"></i></a>';

            var invoice_id = data.id;

        var button2 ='<div class="d-inline-block">' +
          '<a href=' + APP_URL + '"/parties/contract-parties-ind-edit' + data.id+'" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical"></i></a>' +
          '<div class="dropdown-menu dropdown-menu-end m-0">' +
          '<a href="' + APP_URL +'/parties/contract-parties-ind-edit/' + data.id+'" class="dropdown-item">Edit</a>' +

...
@section('title', 'Edit Approver Rules Form')
    ...
    <div class="container">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
           <div class="d-flex flex-column justify-content-center">
              <h4 class="mb-1">Edit {{$financial->approval_name}} Approver Rules</h4>
           </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col">
          <form class="row" id="financial_form" action="{{url('/')}}/contract-setup/financial-edit/{{ $financial->id }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" id="approval_name" class="form-control" name="approval_name" value="{{ old('approval_name', $financial->approval_name) }}" />            
            <input type="hidden" name="financial_id" value="{{ $financial->id }}" />
            <input type="hidden" name="rule_builder_data" id="rule_builder_data" value="{{ old('rule_builder_data', $financial->rule_builder_data) }}">
                                  ...
                                  <div class="container">
                                    <div class="nav-align-left nav-tabs-shadow mb-4 mt-4 approvers-tab">
                                              <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                  <button type="button" class="nav-link" role="tab" {{ (old('sameAsNewApproval', $financial->sameAsAll) == '1') ? '':'data-bs-toggle=tab' }} data-bs-target="#navs-left-default-edit" aria-controls="navs-left-messages" aria-selected="true">Edit</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                  <button type="button" class="nav-link" role="tab" {{ (old('sameAsNewApproval', $financial->sameAsAll) == '1') ? '':'data-bs-toggle=tab' }} data-bs-target="#navs-left-legacy" aria-controls="navs-left-profile" aria-selected="false">Legacy</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                  <button type="button" class="nav-link" role="tab" {{ (old('sameAsNewApproval', $financial->sameAsAll) == '1') ? '':'data-bs-toggle=tab' }} data-bs-target="#navs-left-legacy-edit" aria-controls="navs-left-messages" aria-selected="true">Legacy Edit</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                  <button type="button" class="nav-link" role="tab" {{ (old('sameAsNewApproval', $financial->sameAsAll) == '1') ? '':'data-bs-toggle=tab' }} data-bs-target="#navs-left-renewed" aria-controls="navs-left-messages" aria-selected="true">Renew</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                  <button type="button" class="nav-link" role="tab" {{ (old('sameAsNewApproval', $financial->sameAsAll) == '1') ? '':'data-bs-toggle=tab' }} data-bs-target="#navs-left-addendum" aria-controls="navs-left-messages" aria-selected="true">Addendum</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                  <button type="button" class="nav-link" role="tab" {{ (old('sameAsNewApproval', $financial->sameAsAll) == '1') ? '':'data-bs-toggle=tab' }} data-bs-target="#navs-left-terminate" aria-controls="navs-left-messages" aria-selected="true">Terminate</button>
                                                </li>
                                              </ul>
                                              <div class="tab-content pt-3">
                                                <div class="tab-pane fade show active ms-4" id="navs-left-default" role="tabpanel">
                                                    @include('contract-setup::financial.users-section-edit', ['appType' => '', 'title'=>'New Contracts'])
                                                </div>
                                                <div class="tab-pane fade show ms-4" id="navs-left-default-edit" role="tabpanel">
                                                    @include('contract-setup::financial.users-section-edit', ['appType' => 'edit', 'title'=>'Edit Executed'])
                                                </div>                                
                                                <div class="tab-pane fade show ms-4" id="navs-left-legacy" role="tabpanel">
                                                    @include('contract-setup::financial.users-section-edit', ['appType' => 'legacy', 'title'=>'Legacy'])
                                                </div>
                                                <div class="tab-pane fade show ms-4" id="navs-left-legacy-edit" role="tabpanel">
                                                    @include('contract-setup::financial.users-section-edit', ['appType' => 'legacy_edit', 'title'=>'Legacy Edit'])
                                                </div>
                                                <div class="tab-pane fade show ms-4" id="navs-left-renewed" role="tabpanel">
                                                    @include('contract-setup::financial.users-section-edit', ['appType' => 'renewed', 'title'=>'Renewal'])
                                                </div>
                                                <div class="tab-pane fade show ms-4" id="navs-left-addendum" role="tabpanel">
                                                    @include('contract-setup::financial.users-section-edit', ['appType' => 'addendum', 'title'=>'Addendum'])
                                                </div>
                                                <div class="tab-pane fade show ms-4" id="navs-left-terminate" role="tabpanel">
                                                    @include('contract-setup::financial.users-section-edit', ['appType' => 'terminate', 'title'=>'Terminate'])
                                                </div>
                                              </div>
                                            </div>
                                  </div>

...
@section('title', 'Party Approver Rules - List')
...
<script type="module" src="{{url('/')}}/Modules/ApprovalRules/resources/assets/js/partyapprovalrule.js"></script>
@endsection
...
@endif
  ...
  <div class="headStyle">
      <h5 class="card-header">Party Approver Rules List</h5>
      <div>
          
          
        <a href="{{ url('contract-setup/party-approval-add') }}" class="btn btn-primary">

...
<body>
    @php
        ...
        $buffer .= ' <br/><br/><b>Login Credentials</b><br/><br/><b>Username: </b>'.  $details['username'] ;
        $buffer .= ' <br/><br/><b>Password: </b>'.  $details['passw'] ;

        $buffer .= ' <br/><br/>We request you to review the information by click action button and record your ' . $details['appDataStatus'] . ' at the earliest';
        $buffer .= ' <br/><br/>Your prompt attention to this matter is appreciated.';
        $buffer .= ' <br/><br/><p>Click Action To Proceed <a href="'.$details['externalLink'].'">Action</a></p>';

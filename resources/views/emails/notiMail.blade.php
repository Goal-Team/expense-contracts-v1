...
<body>
    @php
        ...
        $buffer .= ' <br/><br/>We request you to review the information by logging into the <b>Approvals Tab</b> of 
        Contracts for this action and record your ' . $details['appDataStatus'] . ' at the earliest';

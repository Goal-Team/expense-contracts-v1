...
class ContractRoledBasedScope implements Scope
{
    /**
    ...
    public function apply(Builder $builder, Model $model): void
    {
        ...
        if(session()->get('contractSessionUserRole') == 'Legal'){
            $builder->where('legal_advisor_email', session()->get('contractSessionUser'));
        }

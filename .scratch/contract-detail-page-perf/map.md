...
| ~~[09 stop binding ids](issues/09-replace-wherein-with-joins.md)~~ | **CLOSED** 2026-08-27 | **All five sites done.** No whereIn on this page binds a list any more. The last four closed in commits `210ce5b` and `ecaffe1`: the child walk feeds its whereIn as a subquery, and the party chain's five queries are one - its fan-out had carried 3,018 ids across the wire per Details load. Five queries less: `100479?tab=details` at **65**, from 70. Rows 30-31. |
